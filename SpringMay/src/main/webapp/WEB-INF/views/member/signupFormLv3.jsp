...
<link rel="stylesheet" href="/resources/css/signupFormLv3.css">
<script src="http://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
<script src="/resources/js/signupFormLv3.js" defer></script>
...
<div id="header3">
        ...
        <div id="board">
			...
			<form role="form" action="/member/signup" method="post">			<!-- form -->
				<div id="membership_content">
					<div id="membership_icon">
						...
						<img src="/resources/images/mem_prcs_arrow.png" class="arrow">
						<div class="order">
							<img src="/resources/images/mem_prcs04_on.png" class="order_icon">
					...
					<table id="tab">
						...
						<tr>
							...
							<td class="td2">
							<input type="text" class="box_normal" id="userid" name="userid">
								<button id='id_check' type="button">중복확인</button>
								<div class="error" id="error__id"></div><div class="error" id="error__id_duplicate"></div> <br> 
								<span class="sub">*아이디는 영문과 숫자를 혼용하여 6~20자만 가능합니다.</span>
							</td>
						</tr>
						<tr>
							<td class="td1_2"><span class="star">*</span>비밀번호</td>
							<td class="td2"><input type="password" class="box_normal"
								id="userpw1" name="userpw">
								<div class="error" id="error__password1"
						...
						<tr>
							...
							<td class="td2">
								<div>
									<input class="radioGender" type="radio" name="gender" value="man"id="gender__man" style="display: inline-block;" /> 
										<span class="gender">남성</span>
								</div> 
								<div>
									<input class="radioGender" type="radio" name="gender"value="woman" id="gender__woman" style="display: inline-block;" />
						...
						<tr>
							...
							<td class="td2"><input type="text" name="birthday" class="box_normal" id="birthday" maxlength="8" /> 8자리로 입력하세요 ex)19990822
						...
						<tr>
							...
							<td class="td2">
								...
								<input type="text" class="box_small phone" id="phone1" name="phone1" maxlength="3">-
								<input type="text" class="box_small phone" id="phone2" name="phone2" maxlength="4">-
								<input type="text" class="box_small phone" id="phone3" name="phone3" maxlength="4">
								<button class="auth_button" id="send" type="button" disabled="disabled">인증번호 전송</button> <span id="token">000000</span>
						...
						<tr>
							...
							<td class="td2">
								<input type="text" class="box_normal" placeholder="우편번호" name="addresscode" id="addresscode">
								<button type='button' id="findAdd" onClick="sample6_execDaumPostcode()">우편번호찾기</button><br>
								<input type="text" class="box_normal" placeholder="주소" name="address" id="address"><br>
								<input type="text" class="box_normal" placeholder="상세주소" id="address_detail" name="addressdetail">
								<input type="text" class="box_normal" placeholder="참고항목" name="addressnote" id="addressnote">
								<div class="error" id="error__address"></div>
							</td>
						</tr>
						<tr>
							<td class="td1_2"><span class="star">*</span>이메일</td>
							<td class="td2"><input type="text" class="box_normal" name="email1" id="email1">@
							<input typee="text" id="email2" class="box_normal" name="email2"> 
					...
					<div id="complete">
						<button class="confirm__button" id="signup__button" type="submit">가입하기</button>
					</div>
				</div>
			</form>
